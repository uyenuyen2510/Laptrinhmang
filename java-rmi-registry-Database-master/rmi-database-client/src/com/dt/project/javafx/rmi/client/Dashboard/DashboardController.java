 ...
 */
package com.dt.project.javafx.rmi.client.Dashboard;

import com.dt.project.javafx.rmi.client.ResizeHelper;
...
public class DashboardController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try {
            s = (Node) FXMLLoader.load(getClass().getResource("/com/dt/project/javafx/rmi/client/Home/home.fxml"));
        ...
        try {
            AnchorPane box = FXMLLoader.load(getClass().getResource("/com/dt/project/javafx/rmi/client/SidePane/SidePane.fxml"));
