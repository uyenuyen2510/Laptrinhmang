 ...
 */
package com.dt.project.javafx.rmi.server.Dashboard;
...
public class DashboardController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try {
            s = (Node) FXMLLoader.load(getClass().getResource("/com/dt/project/javafx/rmi/server/home/home.fxml"));
        ...
        try {
            AnchorPane box = FXMLLoader.load(getClass().getResource("/com/dt/project/javafx/rmi/server/SidePane/SidePane.fxml"));
