 ...
 */
package com.dt.project.javafx.rmi.server.update;
...
import static com.dt.project.javafx.rmi.server.utilities.StudentRe.insertPerson;
...
public class UpdateStudentController implements Initializable {
    ...
    @FXML
    public TextField txtPic;
    @FXML
    public JFXDatePicker dtPkr;
    @FXML
...
//        System.out.println(RegistrationCardController.number);
    ...
    public void setMain(StudentProgressController aThis) {
